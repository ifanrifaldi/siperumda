...
@section('content')
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Menu Perdagangan</div>
                @if ($list_perdagangan->count() == 0)
                ...
                <div class="modal fade" id="basicModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('perdagangan') }}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0"
                        ...
                        <tbody>
                            ...
                            @foreach ($list_perdagangan as $perdagangan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            {{-- @if ($perdagangan->count() == 0) --}}
                                            <a href="" class="btn btn-warning" data-toggle="modal"
                                                data-target="#edit{{ $perdagangan->id }}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            {{-- @endif --}}
                                            @include('components.utils.delete', [
                                                'url' => url('perdagangan', $perdagangan->id),
                                            ])
                                    ...
                                    <td>{{ $perdagangan->nama_bisnis }}</td>
                                    <td>{{ $perdagangan->keterangan }}</td>
                                    {{-- <td>{{ $beranda->foto }}</td> --}}
                                    {{-- <td>{{ $beranda->foto }}</td> --}}
                                    {{-- <td>
                                                    <img style="height: 20px"
                                                        src="{{ url("public/$perdagangan->foto") }}" alt="">
                                                </td> --}}
                                    <td>
                                        <img style="height: 100px" src="{{ url("$perdagangan->foto") }}" alt="">
                                    </td>
                                ...
                                {{-- Modal Edit Start --}}
                                @foreach ($list_perdagangan as $perdagangan)
                                    <div class="modal fade" id="edit{{ $perdagangan->id }}">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form action="{{ url('perdagangan', $perdagangan->id) }}" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama_bisnis" class="form-control"
                                                                value="{{ $perdagangan->nama_bisnis }}" id="nama_bisnis">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="keterangan" class="control-label">Keterangan</label>
                                                            <input type="text" name="keterangan" class="form-control"
                                                                value="{{ $perdagangan->keterangan }}" id="keterangan">
                                                        </div>
