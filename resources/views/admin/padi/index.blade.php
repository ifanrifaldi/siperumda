...
@section('content')
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Menu Pengilingan Padi</div>
                @if ($list_padi->count() == 0)
                ...
                <div class="modal fade" id="basicModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="{{ url('padi') }}" method="post" enctype="multipart/form-data">
                                @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($list_padi as $padi)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="" class="btn btn-warning" data-toggle="modal"
                                                data-target="#edit{{ $padi->id }}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            @include('components.utils.delete', [
                                                'url' => url('padi', $padi->id),
                                            ])
                                    ...
                                    <td>{{ $padi->nama_bisnis }}</td>
                                    <td>{{ $padi->keterangan }}</td>
                                    {{-- <td>{{ $beranda->foto }}</td> --}}
                                    {{-- <td>{{ $beranda->foto }}</td> --}}
                                    {{-- <td>
                                                    <img style="height: 20px"
                                                        src="{{ url("public/$padi->foto") }}" alt="">
                                                </td> --}}
                                    <td>
                                        <img style="height: 100px" src="{{ url("$padi->foto") }}" alt="">
                                    </td>
                                ...
                                {{-- Modal Edit Start --}}
                                @foreach ($list_padi as $padi)
                                    <div class="modal fade" id="edit{{ $padi->id }}">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form action="{{ url('padi', $padi->id) }}" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama_bisnis" class="form-control"
                                                                value="{{ $padi->nama_bisnis }}" id="nama_bisnis">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="keterangan" class="control-label">Keterangan</label>
                                                            <input type="text" name="keterangan" class="form-control"
                                                                value="{{ $padi->keterangan }}" id="keterangan">
                                                        </div>
