...
@section('content')
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Menu Pembenihan Dan Pembibitan</div>
                @if ($list_pembenihan->count() == 0)
                ...
                <div class="modal fade" id="basicModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="{{ url('pembenihan') }}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0"
                        ...
                        <tbody>
                            ...
                            @foreach ($list_pembenihan as $pembenihan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="" class="btn btn-warning" data-toggle="modal"
                                                data-target="#edit{{ $pembenihan->id }}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            @include('components.utils.delete', [
                                                'url' => url('pembenihan', $pembenihan->id),
                                            ])
                                    ...
                                    <td>{{ $pembenihan->nama_bisnis }}</td>
                                    <td>{{ $pembenihan->keterangan }}</td>
                                    {{-- <td>{{ $beranda->foto }}</td> --}}
                                    {{-- <td>{{ $beranda->foto }}</td> --}}
                                    {{-- <td>
                                                    <img style="height: 20px"
                                                        src="{{ url("public/$pembenihan->foto") }}" alt="">
                                                </td> --}}
                                    <td>
                                        <img style="height: 100px" src="{{ url("$pembenihan->foto") }}" alt="">
                                    </td>
                                ...
                                {{-- Modal Edit Start --}}
                                @foreach ($list_pembenihan as $pembenihan)
                                    <div class="modal fade" id="edit{{ $pembenihan->id }}">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form action="{{ url('pembenihan', $pembenihan->id) }}" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama_bisnis" class="form-control"
                                                                value="{{ $pembenihan->nama_bisnis }}" id="nama_bisnis">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="keterangan" class="control-label">Keterangan</label>
                                                            <input type="text" name="keterangan" class="form-control"
                                                                value="{{ $pembenihan->keterangan }}" id="keterangan">
                                                        </div>
